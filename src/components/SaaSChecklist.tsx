          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-white text-center">
            ...
            <p className="text-lg opacity-90">
              Validate your SaaS idea in 2 minutes. Get your score and actionable feedback.
                    ...
                    {/* Checklist Section - Show First */}
          <div className="p-8">
            <div className="text-center mb-8">
              <div className="flex items-center justify-center mb-4">
                <Star className="w-8 h-8 text-blue-600 mr-3" />
                <h2 className="text-2xl font-bold text-gray-900">SaaS Idea Validation Checklist</h2>
              </div>
              <p className="text-gray-600 max-w-2xl mx-auto">
                Complete the checklist below to get your personalized validation score. Each item you check will improve your score and help you understand how well-validated your SaaS idea is.
              </p>
            </div>
            ...
            {/* Email Capture Section - Show After Checklist */}
            {!isSubmitted ? (
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-xl border border-blue-200">
                <div className="text-center mb-6">
                  <div className="flex items-center justify-center mb-4">
                    <Mail className="w-8 h-8 text-blue-600 mr-3" />
                    <h3 className="text-xl font-bold text-gray-900">Get Your Detailed Results</h3>
                  </div>
                  <p className="text-gray-600">
                    Enter your email to receive your personalized validation score with detailed feedback and actionable next steps.
                  </p>
                </div>
                ...
                <form onSubmit={handleEmailSubmit} className="max-w-md mx-auto">
                  ...
                  >
                    {isLoading ? 'Loading...' : 'Get My Detailed Results'}
                  </button>
                  {error && (
              ...
              /* Results Section - Show after email capture */
              <div className="bg-gradient-to-r from-green-50 to-blue-50 p-6 rounded-xl border border-green-200">
                <div className="text-center">
                  <div className="flex items-center justify-center mb-4">
                    <Star className="w-8 h-8 text-green-600 mr-3" />
                    <h3 className="text-xl font-bold text-gray-900">Your Validation Results</h3>
                  </div>
                  <div className={`p-4 rounded-lg border ${scoreMessage.bgColor} ${scoreMessage.borderColor} mb-4`}>
                    <div className="text-center">
                      ...
                      <h4 className={`text-lg font-semibold mb-2 ${scoreMessage.color}`}>
                        {scoreMessage.title}
                      </h4>
