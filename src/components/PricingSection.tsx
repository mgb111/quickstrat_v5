...
const PricingSection: React.FC = () => {
  try {
    ...
    console.log('Rendering PricingSection: billing toggle');
    // Billing Toggle
    ...
    console.log('Rendering PricingSection: pricing cards');
    // Pricing Cards
    ...
    console.log('Rendering PricingSection: additional info');
    // Additional Info
    ...
    console.error('❌ Error in PricingSection render:', err);
    return null;
  }
};
