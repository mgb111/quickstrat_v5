...
const PublicLandingPage: React.FC<PublicLandingPageProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-white font-inter">
      ...
      {/* Product Demo Section - Majorbeam Style */}
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Watch how easy it is to create professional lead magnets
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-gray-900 rounded-2xl overflow-hidden shadow-2xl">
                <div className="aspect-video bg-yellow-600 flex items-center justify-center">
                  <div className="text-center text-white">
                    <Play className="w-16 h-16 mx-auto mb-4" />
                    <p className="text-lg font-semibold">Watch Demo</p>
                    <p className="text-yellow-200">2:30 min</p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-8">
              ...
              <p className="text-gray-600">
                    Our AI understands your industry and creates compelling content that resonates with your target audience.
              </p>
                </div>
            </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Professional PDF Design</h3>
              <p className="text-gray-600">
                    Get beautifully designed PDFs that establish your authority and convert visitors into leads.
              </p>
                </div>
            </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Landing Page Creation</h3>
              <p className="text-gray-600">
                    Generate high-converting landing pages that capture emails and drive your lead generation campaigns.
              </p>
                </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Email Capture System</h3>
              <p className="text-gray-600">
                    Built-in email capture with export functionality to manage and nurture your leads effectively.
              </p>
                </div>
              </div>
            </div>
