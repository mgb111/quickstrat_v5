-- Fix dependencies by dropping tables in correct order with CASCADE
-- This migration handles existing table dependencies properly
...
DROP FUNCTION IF EXISTS update_campaign_lead_count() CASCADE;
